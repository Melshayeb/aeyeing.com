...
def _builtin_city_places(city: str, country: str, kind: str, limit: int = 30) -> List[Dict]:
    ...
    places = {
        ...
        "santiago": {
            "attractions": [
                {"name": "Plaza de Armas", "tags": ["history & culture", "architecture", "photography"], "best_time": ["morning", "afternoon"], "lat": -33.4372, "lon": -70.6506},
                {"name": "Cerro San Cristóbal / Metropolitan Park", "tags": ["views", "parks & outdoors", "hiking & adventure"], "best_time": ["morning", "afternoon"], "lat": -33.4254, "lon": -70.6325},
                {"name": "La Moneda Palace", "tags": ["history & culture", "architecture"], "best_time": ["morning", "afternoon"], "lat": -33.4429, "lon": -70.6537},
                {"name": "Sky Costanera (Gran Torre Santiago)", "tags": ["views", "architecture", "photography"], "best_time": ["evening"], "lat": -33.4179, "lon": -70.6060},
                {"name": "Santa Lucía Hill", "tags": ["history & culture", "parks & outdoors", "views"], "best_time": ["morning", "afternoon"], "lat": -33.4403, "lon": -70.6437},
                {"name": "Mercado Central de Santiago", "tags": ["local markets", "food & drink", "seafood"], "best_time": ["lunch", "afternoon"], "lat": -33.4318, "lon": -70.6510},
                {"name": "Barrio Lastarria", "tags": ["food & drink", "culture", "nightlife"], "best_time": ["afternoon", "evening"], "lat": -33.4358, "lon": -70.6406},
                {"name": "Patio Bellavista", "tags": ["food & drink", "nightlife", "shopping"], "best_time": ["evening"], "lat": -33.4369, "lon": -70.6344},
                {"name": "Museo de la Memoria y los Derechos Humanos", "tags": ["museums & art", "history & culture"], "best_time": ["morning", "afternoon"], "lat": -33.4256, "lon": -70.6806},
                {"name": "Cementerio General de Santiago", "tags": ["history & culture", "architecture", "photography"], "best_time": ["morning", "afternoon"], "lat": -33.4148, "lon": -70.6456},
            ],
            "museums": [
                {"name": "Museo Nacional de Bellas Artes", "tags": ["museums & art", "art galleries"], "best_time": ["morning", "afternoon"], "lat": -33.4349, "lon": -70.6424},
                {"name": "Museo Chileno de Arte Precolombino", "tags": ["museums & art", "history & culture"], "best_time": ["morning", "afternoon"], "lat": -33.4377, "lon": -70.6506},
                {"name": "Museo de la Memoria y los Derechos Humanos", "tags": ["museums & art", "history & culture"], "best_time": ["morning", "afternoon"], "lat": -33.4256, "lon": -70.6806},
                {"name": "Museo Interactivo Mirador (MIM)", "tags": ["museums & art", "kids friendly", "technology"], "best_time": ["morning", "afternoon"], "lat": -33.4195, "lon": -70.6400},
                {"name": "La Chascona (Pablo Neruda house)", "tags": ["museums & art", "history & culture", "literature"], "best_time": ["morning", "afternoon"], "lat": -33.4310, "lon": -70.6350},
            ],
            "markets": [
                {"name": "Mercado Central de Santiago", "tags": ["local markets", "food & drink", "seafood"], "best_time": ["lunch", "afternoon"], "lat": -33.4318, "lon": -70.6510},
                {"name": "La Vega Central", "tags": ["local markets", "food & drink"], "best_time": ["morning", "afternoon"], "lat": -33.4260, "lon": -70.6660},
                {"name": "Pueblito Los Dominicos", "tags": ["local markets", "crafts", "souvenirs"], "best_time": ["morning", "afternoon"], "lat": -33.4080, "lon": -70.5180},
                {"name": "Persa Bio Bío", "tags": ["local markets", "vintage", "antiques"], "best_time": ["morning", "afternoon"], "lat": -33.4600, "lon": -70.6500},
            ],
            "food": [
                {"name": "Boragó", "tags": ["fine dining", "chilean", "tasting menu"], "best_time": ["dinner"], "lat": -33.3860, "lon": -70.6020},
                {"name": "Ambrosía", "tags": ["chilean", "modern", "dinner"], "best_time": ["dinner"], "lat": -33.4190, "lon": -70.6010},
                {"name": "Liguria (Bellavista)", "tags": ["chilean", "bar", "dinner"], "best_time": ["lunch", "dinner"], "lat": -33.4360, "lon": -70.6340},
                {"name": "99 Restaurante", "tags": ["chilean", "seafood", "dinner"], "best_time": ["dinner"], "lat": -33.4190, "lon": -70.6010},
                {"name": "Peumayen Ancestral Food", "tags": ["chilean", "indigenous", "dinner"], "best_time": ["dinner"], "lat": -33.4190, "lon": -70.6010},
                {"name": "Bar Nacional", "tags": ["chilean", "traditional", "lunch", "dinner"], "best_time": ["lunch", "dinner"], "lat": -33.4310, "lon": -70.6510},
                {"name": "Emporio La Rosa", "tags": ["sweets & desserts", "ice cream", "coffee & cafés"], "best_time": ["morning", "afternoon"], "lat": -33.4358, "lon": -70.6406},
                {"name": "El Hoyo", "tags": ["chilean", "traditional", "lunch", "dinner"], "best_time": ["lunch", "dinner"], "lat": -33.4315, "lon": -70.6510},
                {"name": "Juan y Medio", "tags": ["chilean", "sandwiches", "lunch"], "best_time": ["lunch", "afternoon"], "lat": -33.4390, "lon": -70.6430},
                {"name": "Chipe Libre", "tags": ["bar", "cocktails", "dinner"], "best_time": ["evening"], "lat": -33.4360, "lon": -70.6340},
            ],
            "neighborhoods": [
                {"name": "Bellavista", "tags": ["nightlife", "food & drink", "culture"], "best_time": ["evening"], "lat": -33.4350, "lon": -70.6350},
                {"name": "Barrio Lastarria", "tags": ["food & drink", "culture", "art galleries"], "best_time": ["afternoon", "evening"], "lat": -33.4358, "lon": -70.6406},
                {"name": "Providencia", "tags": ["shopping", "food & drink", "upscale"], "best_time": ["morning", "afternoon"], "lat": -33.4230, "lon": -70.6130},
                {"name": "Las Condes", "tags": ["business", "shopping", "upscale"], "best_time": ["morning", "afternoon"], "lat": -33.4180, "lon": -70.6000},
                {"name": "Santiago Centro", "tags": ["history & culture", "local markets", "architecture"], "best_time": ["morning", "afternoon"], "lat": -33.4370, "lon": -70.6500},
            ],
            "day_trips": [
                {"name": "Valparaíso colourful port city", "tags": ["day trip", "history & culture", "photography", "unesco"], "best_time": ["morning", "afternoon"], "lat": -33.0458, "lon": -71.6197},
                {"name": "Viña del Mar beach resort", "tags": ["day trip", "beach", "relaxation"], "best_time": ["morning", "afternoon"], "lat": -33.0153, "lon": -71.5515},
                {"name": "Cajón del Maipo (Andes canyon)", "tags": ["day trip", "nature & wildlife", "hiking & adventure"], "best_time": ["morning", "afternoon"], "lat": -33.7370, "lon": -70.2700},
                {"name": "Concha y Toro Winery", "tags": ["day trip", "wine & cocktails", "food & drink"], "best_time": ["morning", "afternoon"], "lat": -33.6360, "lon": -70.5470},
                {"name": "Isla Negra (Pablo Neruda museum)", "tags": ["day trip", "history & culture", "literature", "beach"], "best_time": ["morning", "afternoon"], "lat": -33.6910, "lon": -71.6870},
            ],
            "hotels": [
                {"name": "Hotel Ismael", "price": "~USD 140", "location": "Lastarria / Centro", "highlights": "Boutique hotel near Bellas Artes and Lastarria dining"},
                {"name": "Luciano K Hotel", "price": "~USD 170", "location": "Providencia", "highlights": "Art-deco boutique hotel close to Metro and dining"},
                {"name": "Novotel Santiago Vitacura", "price": "~USD 130", "location": "Vitacura", "highlights": "Modern mid-range base near shopping and dining"},
            ],
        },
    }
