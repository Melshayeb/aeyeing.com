...
class WebsiteUpdater:
    ...
    def update(self, scan_results: list, active_plan: dict = None, scan_stats: dict = None, ticker_ids: Dict[str, int] = None):
        ...
        try:
            ...
            # Write the rolling latest file (for easy manual inspection) and a uniquely-named
            # snapshot. The unique filename defeats every cache layer (Cloudflare edges, mobile
            # carrier proxies, browser caches). Both files are committed/pushed.
